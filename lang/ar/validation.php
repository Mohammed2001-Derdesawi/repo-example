...
return [
    ...
    */
    ...
    'basic_cousre_not_in_subscribers'=>'الكورس الأساسي لا يمكن أن يكون في كورسات التخصص',
    ...
    */
    ...
    'attributes' => [
        ...
        'deadlineday'=>'يوم تاريخ انتهاء التقديم ',
        'deadlinemonth'=>'شهر تاريخ انتهاء التقديم',
        'deadlineyear'=>'سنة تاريخ انتهاء التقديم',
        'basic_subscribe_course'=>'الكورس الأساسي',
        'subscribe_courses'=>'كورسات التخصص',
        'subscribe_courses.*'=>'الكورس (:position)',
        'city'=>'المدينة',
        'usersIds'=>'معرفات المتدربين',
        'whatsup_message'=>'الرسالة',
        'base_course_id'=>'الكورس الأساسي',
        'to_course_id'=>'إلى الكورس',
    ],
